...
public class ConnectionController
{
	...
	public String login(Model model, @RequestParam("login") String login1, @RequestParam("motdepasse") String password1,
			...
			if (internaute != null)
			{
				if (password.equals(internaute.getPassword()))
				{
					...
					if (!(auth instanceof AnonymousAuthenticationToken))
					{
						...
						logger.info("Connexion R�ussie pour {}. ",
	...
	public String logoutMemberPost(Model model, HttpServletRequest request, HttpServletResponse response)
	{
		...
		if (login != null)
		{
			...
			logger.info("D�connexion R�ussie pour {}. ", chercheur);
			return "connection";
		}
		return "index";
	}
